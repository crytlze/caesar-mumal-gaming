...
// Use /tmp for Vercel (serverless), local otherwise
...
if (cnt === 0) {
  ...
  const games = [
    ['Mobile Legends','mobile-legends','Top Up Diamond MLBB.','/img/games/mlbb.png','User ID','Contoh: 12345678','Zone ID','Contoh: 1234',1,1],
    ['Free Fire','free-fire','Top Up Diamond FF.','/img/games/freefire.svg','Player ID','Contoh: 87654321','','',0,2],
    ['PUBG Mobile','pubg-mobile','Beli UC PUBG Mobile.','/img/games/pubg.webp','Player ID','Contoh: 51234567','','',0,3],
    ['Valorant','valorant','Beli VP instan.','/img/games/valorant.svg','Riot ID','Contoh: Player#1234','','',0,4],
    ['Genshin Impact','genshin-impact','Genesis Crystal Genshin.','/img/games/genshin.svg','UID','Contoh: 801234567','Server','Asia / America / Europe / TW, HK, MO',1,5]
  ];
